...
const ManageAddress = () => {
  ...
  const saveEdit = async (id: number) => {
    await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/user/address/${id}`, {
      method: "POST",
      headers: {
            ...
            <div className="col-span-12 md:col-span-9 space-y-1">
              ...
              {editingId === item.id ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <input
                    className="mt-1 w-full p-3 rounded-full border border-gray-300 focus:border-orange-400 outline-none md:col-span-2"
